...
pl ./data/fast_2.csv -t "Kronecker algorithms on x^{2^n}+2" -x "n" -y "Time ms" -l -o images/fast_2.png
pl ./data/fast_3.csv -t "Kronecker algorithms on Phi_{n}" -x "n" -y "Time ms" -l -o images/fast_3.png
pl ./data/fast_4.csv -t "Kronecker algorithms on x^{2 2^n}+x^{2^nn}-2" -x "n" -y "Time ms" -l -o images/fast_4.png
